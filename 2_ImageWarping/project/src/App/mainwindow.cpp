...
void MainWindow::CreateActions()
{
	...
	action_warp_ = new QAction(tr("Choose"), this);
	action_warp_->setStatusTip(tr("Choose warping direction"));
	connect(action_warp_, &QAction::triggered, imagewidget_, &ImageWidget::Warp);

	action_IDW_ = new QAction(tr("IDW"), this);
	action_IDW_->setStatusTip(tr("Warping with IDW"));
	connect(action_IDW_, &QAction::triggered, imagewidget_, &ImageWidget::IDWWarping);

	action_RBF_ = new QAction(tr("RBF"), this);
	action_RBF_->setStatusTip(tr("Warping with RBF"));
	connect(action_RBF_, &QAction::triggered, imagewidget_, &ImageWidget::RBFWarping);

	action_fill_ = new QAction(tr("fill"), this);
	action_fill_->setStatusTip(tr("Fill the hole"));
	connect(action_fill_, &QAction::triggered, imagewidget_, &ImageWidget::AnnFillHole);
...
void MainWindow::CreateMenus()
{
	...
	menu_edit_->addAction(action_fill_);
...
void MainWindow::CreateToolBars()
{
	...
	toolbar_file_->setMovable(false);
	...
	toolbar_file_->addAction(action_fill_);
